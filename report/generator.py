...
<head>
  ...
  <title>Stealth Lightbeacon - Audit Diagnostics Report</title>
...
<body>
  <div class="container">
    ...
    <div class="dashboard-grid">
      ...
      <div class="card">
        ...
        <div style="font-size: 0.9rem; color: var(--text-muted); display: flex; flex-direction: column; gap: 10px; margin-top: 10px;">
          ...
          <div><strong>Audit Engine Version:</strong> v1.2.4</div>
        </div>
      </div>
    </div>
    ...
    <footer>
      Stealth Lightbeacon Diagnostics Report — Compiled Offline
    </footer>
  </div>
</body>
</html>
