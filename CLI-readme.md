...
The runtime identity and docs surface are aligned with the `v1.2.7` release train.
...
- The `v1.2.7` release publishes the canonical HTTP service, contract validator, and end-to-end smoke coverage alongside the CLI.
