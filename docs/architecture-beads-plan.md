...
- ARC-7 architectural review: `ARC7-REVIEW-stealth-lightbeacon-main-2026-05-25.md`
...
`E`
- ARC-7 finding ARC7-2.
- `modules/html_parser.py` keeps a module-level `SelectorResolver`.
...
`E`
- ARC-7 finding ARC7-3.
- `modules/scraping/stealth_mcp.py` defaults to
  `npx -y @modelcontextprotocol/server-playwright`.
- The process is spawned without a timeout or explicit version pin.
